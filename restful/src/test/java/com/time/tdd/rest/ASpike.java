...
import com.time.tdd.di.container.ComponentRef;
import com.time.tdd.di.container.Config;
import com.time.tdd.di.container.Context;
import com.time.tdd.di.container.ContextConfig;
...
public class ASpike {
    ...
    static class ResourceServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            ...
            MessageBodyWriter<Object> writer =
                (MessageBodyWriter<Object>) providers.getMessageBodyWriter(result.getClass(), null, null, null);
        ...
        Object dispatch(HttpServletRequest request, List<Class<?>> rootResources) {
            try {
                Class<?> rootClass = rootResources.stream().findFirst().get();
    ...
    static class TestProviders implements Providers {
        ...
        public TestProviders(TestApplication application) {
            ...
            List<Class<?>> writerClasses =
                this.application.getClasses().stream().filter(MessageBodyWriter.class::isAssignableFrom).toList();
