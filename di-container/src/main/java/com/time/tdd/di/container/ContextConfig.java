...
import static com.time.tdd.di.container.ContextConfig.ContextConfigError.circularDependencies;
import static com.time.tdd.di.container.ContextConfig.ContextConfigError.unsatisfiedResolution;
import static com.time.tdd.di.container.ContextConfig.ContextConfigException.illegalAnnotation;
...
public class ContextConfig {
    ...
    public <Type, Implementation extends Type> void component(Class<Type> type, Class<Implementation> implementation,
    ...
    static class Bindings {
        ...
        private static Class<? extends Annotation> typeOf(final Annotation annotation) {
            return Stream.of(Qualifier.class, Scope.class).filter(a -> annotation.annotationType().isAnnotationPresent(a)).findFirst()
