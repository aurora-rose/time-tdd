    ...
    class ConstructorInjectionTest {
        ...
        class Injection {
            ...
            void should_include_dependency_type_from_inject_constructor() {
                ...
                assertArrayEquals(new ComponentRef[] {ComponentRef.of(providerDependencyType)},
                    provider.getDependencies().toArray(ComponentRef[]::new));
            ...
            class WithQualifier {
                ...
                void should_throw_exception_if_multi_qualifiers_given() {
                    ...
                    assertEquals(
                        "Ambiguous qualifiers: @jakarta.inject.Named(\"ChosenOne\") , @com.time.tdd.di.container.Skywalker() on com.time.tdd.di.container.Dependency dependency of class com.time.tdd.di.container.InjectionTest$ConstructorInjectionTest$Injection$WithQualifier$MultiQualifierInjectConstructor",
                        error.getMessage());
                }
        ...
        class IllegalInjectConstructor {
            ...
            void should_throw_exception_if_component_is_abstract() {
                ...
                assertEquals(
                    "Can not be abstract: class com.time.tdd.di.container.InjectionTest$ConstructorInjectionTest$IllegalInjectConstructor$AbstractComponent",
                    error.getMessage());
            }
            ...
            void should_throw_exception_if_component_is_interface() {
                ...
                assertEquals("Can not be abstract: interface com.time.tdd.di.container.TestComponent",
                    error.getMessage());
            }

            @Test
            void should_throw_exception_if_multi_inject_constructors_provided() {
                InjectionProvider.ComponentError error =
                    assertThrows(InjectionProvider.ComponentError.class, () -> new InjectionProvider<>(MultiInjectConstructors.class));
                assertEquals(
                    "Ambiguous injectable constructors: class com.time.tdd.di.container.InjectionTest$ConstructorInjectionTest$IllegalInjectConstructor$MultiInjectConstructors",
                    error.getMessage());
            }
            ...
            void should_throw_exception_if_no_default_constructor_nor_inject_constructor() {
                InjectionProvider.ComponentError error = assertThrows(InjectionProvider.ComponentError.class,
                    () -> new InjectionProvider<>(NoDefaultConstructorNorInjectConstructor.class));
                assertEquals(
                    "No default constructors: class com.time.tdd.di.container.InjectionTest$ConstructorInjectionTest$IllegalInjectConstructor$NoDefaultConstructorNorInjectConstructor",
                    error.getMessage());
            }
    ...
    class FiledInjectionTest {
        ...
        class Injection {
            ...
            class WithQualifier {
                ...
                void should_throw_exception_if_multi_qualifiers_given() {
                    ...
                    assertEquals(
                        "Ambiguous qualifiers: @jakarta.inject.Named(\"ChosenOne\") , @com.time.tdd.di.container.Skywalker() on com.time.tdd.di.container.Dependency com.time.tdd.di.container.InjectionTest$FiledInjectionTest$Injection$WithQualifier$MultiQualifierInjectField.dependency of class com.time.tdd.di.container.InjectionTest$FiledInjectionTest$Injection$WithQualifier$MultiQualifierInjectField",
                        error.getMessage());
                }
        ...
        class IllegalInjectField {
            ...
            void should_throw_exception_if_inject_field_is_final() {
                ...
                assertEquals(
                    "Injectable field can not be final: dependency in class com.time.tdd.di.container.InjectionTest$FiledInjectionTest$IllegalInjectField$FinalFieldInject",
                    error.getMessage());
    ...
    class MethodInjectionTest {
        ...
        class Injection {
            ...
            void should_only_call_once_if_subclass_override_inject_method() {
                SubclassWithOverrideSuperClassWithInjectMethod component =
                    new InjectionProvider<>(SubclassWithOverrideSuperClassWithInjectMethod.class).get(context);
                assertEquals(1, component.superCalled);
            }

            @Test
            void should_not_call_inject_method_if_override_inject_method_not_inject_annotation() {
                SubclassWithOverrideSuperClassWithNoInject component =
                    new InjectionProvider<>(SubclassWithOverrideSuperClassWithNoInject.class).get(context);
            ...
            class WithQualifier {
                ...
                void should_throw_exception_if_multi_qualifiers_given() {
                    ...
                    assertEquals(
                        "Ambiguous qualifiers: @jakarta.inject.Named(\"ChosenOne\") , @com.time.tdd.di.container.Skywalker() on com.time.tdd.di.container.Dependency dependency of class com.time.tdd.di.container.InjectionTest$MethodInjectionTest$Injection$WithQualifier$MultiQualifierInjectMethod",
                        error.getMessage());
                }
        ...
        class IllegalInjectMethod {
            ...
            void should_throw_exception_if_inject_method_has_type_parameter() {
                ...
                assertEquals(
                    "Injectable method can not have type parameter: install in class com.time.tdd.di.container.InjectionTest$MethodInjectionTest$IllegalInjectMethod$TypeParameterInjectMethod",
                    error.getMessage());
            }
